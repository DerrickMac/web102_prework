...
// use reduce() to find the total amount of games
...
const unfundedGamesString = unfundedGamesCount === 1 ? "1 game" : `${unfundedGamesCount} games`;
const displayString = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${unfundedGamesString} remains unfunded. We need your help to fund these amazing games!`;
